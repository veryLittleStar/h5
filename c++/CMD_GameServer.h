...
//////////////////////////////////////////////////////////////////////////////////
//登录命令
#define GS_MGS_BEGIN 20

#define MDM_GR_LOGON				GS_MGS_BEGIN + 1					//登录信息

//登录模式
#define SUB_GR_LOGON_USERID			1									//I D 登录
#define SUB_GR_LOGON_ACCOUNTS		2									//帐户登录
#define SUB_GR_LOGON_MOBILE			3									//手机登录
...
#define MDM_GR_CONFIG				GS_MGS_BEGIN + 2					//配置信息
...
#define MDM_GR_USER					GS_MGS_BEGIN + 3					//用户信息
...
#define MDM_GR_STATUS				GS_MGS_BEGIN + 4					//状态信息
...
#define MDM_GR_INSURE				GS_MGS_BEGIN + 5					//用户信息
...
#define MDM_GR_MANAGE				GS_MGS_BEGIN + 6					//管理命令
...
#define MDM_GR_MATCH				GS_MGS_BEGIN + 7					//比赛命令
